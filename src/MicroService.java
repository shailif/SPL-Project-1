...
public abstract class MicroService implements Runnable {
    ...
    protected Ewoks ewoks;
    protected Diary diary;
    boolean terminated;
    private Object callLock;
    private Object callBLock;
    protected ConcurrentHashMap<Class<? extends Message> , Callback> callMap;
    ...
    public final void run() {
        ...
        while (!terminated){
            try {
                message=msgBus.awaitMessage(this);
